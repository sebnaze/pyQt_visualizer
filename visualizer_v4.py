...
from popEpi_HMR_FHN import paramSpace_4D_v4 as paramSpace4D 
...
class mainVisual(QtGui.QMainWindow):
    ...
    def drawPoint(self, in_y_index, in_y_s, in_x_index, in_x_s, out_y_index, out_y_s, out_x_index, out_x_s):
        ...
        axs = self.mapWin.canvas.fig.get_axes()
    ...
    def drawKOPmap(self):
        ...
        out_img_grid = load('C://Users/Squirel/workspace/HC-Septum-Network/popEpi_HMR_FHN/outImgGridMean_v3.npy')
        out_img_grid_KOP = load('C://Users/Squirel/workspace/HC-Septum-Network/popEpi_HMR_FHN/outImgGridKOP_v3.npy')
        ...
        fig = paramSpace4D.drawFig(out_img_grid, out_img_grid_KOP+out_img_grid_KOP2)
        mapWin = mapWindow()
