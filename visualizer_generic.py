...
in_row_vals = pb.array([0, 0.2, 0.4, 0.6])
in_col_vals = pb.array([0, 0.1, 0.2, 0.3])
out_row_vals = pb.array([2, 2.5, 3, 3.5, 4])
out_row_vals = out_row_vals[::-1] #reverse array to have down -> axes up rather than down
out_col_vals = pb.array([0, 0.2, 0.4, 0.6, 0.8, 1])
...
class mainVisual(QtGui.QMainWindow):
    ...
    def drawKOPmap(self):
        ...
        fig = self.drawFig(out_img_grid_KOP)
        mapWin = mapWindow()
